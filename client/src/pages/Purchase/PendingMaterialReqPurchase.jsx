...
import styles from "./PendingMaterialReqPurchase.module.css";
...
const PendingMaterialReqPurchase = () => {
  ...
  const getApprovalIcon = (status) => {
    ...
    return <Clock size={20} className={styles.waiting} />;
  };
                ...
                return (
                  <tr key={request.id}>
                    ...
                    <td className={styles.actionsCell}>
                      <Link to={`/dashboard/purchase/pending-material-requests/details?ticket-id=${request.id}`} className={styles.actionBtn} title="View Details & Take Action">
                        <Eye size={16} />
                      </Link>
                    </td>
                  </tr>
