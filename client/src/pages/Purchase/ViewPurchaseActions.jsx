...
import styles from "./ViewPurchaseActions.module.css";

const ViewPurchaseActions = () => {
    ...
    const fetchRequests = async () => {
        try {
            ...
            const response = await axios.get(
                `${import.meta.env.VITE_URL_API}/material-requests/purchase-actions`,
                {
            ...
            console.error("Error fetching purchase actions:", error);
            setLoading(false);
        }
    };
                            ...
                            {requests.map((request, index) => (
                                <tr key={request.id}>
                                    ...
                                    <td className={styles.actionCell}>
                                        {getActionBadge(request.purchase_action)}
                                    </td>

                                    <td className={styles.remarksCell}>
                                        {request.purchase_remarks || '-'}
                                    </td>
                                    ...
                                    <td className={styles.actionsCell}>
                                        <Link to={`/dashboard/purchase/pending-material-requests/details?ticket-id=${request.id}`} className={styles.actionBtn} title="View Details">
                                            <Eye size={16} />
                                        </Link>
                                    </td>
                                </tr>
...
export default ViewPurchaseActions;
